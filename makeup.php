...
<script>
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/artistry-make-up-2/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=media_makeup&c_name=Professsional Makeup" ></a></div>
    <!--<div id="boxes">
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/makeup.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Artistry Make Up</h3>
								<a href="http://isasbeautyschool.com/artistry-make-up-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/amu.jpg" width="100%">
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/pmu.jpg" width="100%">
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Professional Make Up</h3>
								<a href="http://isasbeautyschool.com/professional-make-up-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Diploma in Media Makeup</h3>
								<a href="http://isasbeautyschool.com/diploma-in-media-makeup-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/dmmu.jpg" width="100%">
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to Makeup</h3>
                    ...
                    <div class="row">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">Artistry Make Up</h6>
										<p class="text-black">* Art of Techniques in Application & Artistry</p>
										<p class="text-black">* Tools of the Trade</p>
										<p class="text-black">* Understanding Skin Types in Application</p>
										<p class="text-black">* Prep & Prime Tutorial</p>
										<p class="text-black">* Grading of Colors for Features</p>
										<p class="text-black">* Eye Natural, To Fashion Techniques</p>
										<p class="text-black">* Base Theory (Kryolon)</p>
										...
										<p class="text-black">* Makeup Tools:</p>

													<p class="text-black">Sheer</p>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-4 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/k.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="desc">
										<h6 class="text-uppercase text-black">* Professional Make Up</h6>
											<p class="text-black">* Flawless Skin with Base Application & Natural Finish</p>
											<p class="text-black">* Tones for Different lights</p>
											<p class="text-black">* Full coverage to natural finish</p>
											<p class="text-black">* Shading, Contouring Techniques</p>
											<p class="text-black">* Makeup Alignment</p>
											<p class="text-black">* Long wear and Waterproof</p>
											<p class="text-black">* Advance Eye Makeup</p>
											<p class="text-black">* Makeup Tools:</p>
							...
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">Diploma in Media Makeup</h6>

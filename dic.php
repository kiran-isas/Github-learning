...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Diploma in Cosmetology - ISAS</title>
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/diploma-in-cosmetology/"');
				}
				else
				{
					alert(sep[1]);
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/dic.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						<div class="col-lg-5">
							<div class="story-title">
								<h3 class="text-white">Diploma in Cosmetology</h3>
						...
						<div class="col-lg-7">
							<div class="story-box" style="text-align:center">
								<p class="text-uppercase">Basic Beauty</p>
                                <p class="text-uppercase">Basic Hair</p>
                                <p class="text-uppercase">Basic Makeup</p>
								...
								<a href="http://isasbeautyschool.com/diploma-in-cosmetology/" target="_blank" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to DIC</h3>
								<span class="text-uppercase">All Courses Follow National & International Qualifications.</span>
							</div>
						</div>
					</div>
					<center><h4 class="text-uppercase text-black">DIPLOMA IN COSMETOLOGY : Duration : 6 Months</h4></center>
                   ...
                   <div class="col-lg-2 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">BASIC BEAUTY</h6>
						...
						<div class="col-lg-2 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">BASIC HAIR DRESSING</h6>
									<p class="text-black">* Introduction of Hair</p>
                                    <p class="text-black">* Trichology (5)</p>
                                    <p class="text-black">* Common Hair disorders Theory (5)</p>
                                    <p class="text-black">* Trolley Setting</p>
                                    <p class="text-black">* Client Consultation</p>
                                    <p class="text-black">* Shampooing & Conditioning (2)</p>
                                    <p class="text-black">* Distribution Patterns (6)</p>
                                    <p class="text-black">* Thermal Setting (4)</p>
                        ...
                        <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/style.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="desc">
                                         ...
                                         <p class="text-black">Blow Dry Setting (5)</p>
                                    <p class="text-black">* Head Massage</p>
                                    <p class="text-black">* Henna Application</p>
                                    <p class="text-black">* Hair Styling – Styling Product & Tools Theory</p>
                                    <p class="text-black">* Braids(7)</p>
                                    <p class="text-black">* Up-styles (7)</p>
                                    <p class="text-black">* Hair Cutting (9)</p>
                                    <p class="text-black">* Hair Colouring (5)</p>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                        <h6 class="text-uppercase text-black">BASIC MAKEUP</h6>
                           ...
                           <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/make_up.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>

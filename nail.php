...
<head>
	...
	$sel_="select cm_id from campaign where c_id='".$c_id."'";
	$ptr_cm=mysql_query($sel);
		...
		{ 
			...
			var security_code = $("#captcha1").val();
				...
				//alert(staff+">>>>>>>>>"+month+">>>>>>>>>>>>>"+year);
					type: 'post',
					url: 'submitform.php',
					data: { name: name,email:email,mobile_no:mobile_no,c_name:'Cidesco',c_id:'<?php echo $c_id; ?>',cm_id:'<?php echo $cm_id; ?>',s_code:security_code },
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/nail-art-2/"');
				}
				else
				{
					alert(sep[1]);
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/nail_header.jpeg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to Nail</h3>
                    ...
                    <div class="row">
						...
						<div class="col-lg-3 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/nail.jpg);height: 16rem !important;">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">Nail Art</h6>
									<b>Duration: 7 Days</b>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-3 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
										<h6 class="text-uppercase text-black">Nail Extension</h6>

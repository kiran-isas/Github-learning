...
<div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window"> <b style="color:#AA8278;"> Fill Details </b>
    <div id="lorem">
    <center> <form>
					<label>Email </label>
					<br />
					<input type="text" name="email" style="border: 2px solid #AA8278;border-radius: 4px;"/>
					<br />

					<label>Mobile Number</label>
					<br />
					<input type="text" name="mobile_no" style="border: 2px solid #AA8278;border-radius: 4px;"/>
					<br /><br />
					
				</form></center>
    </div>
    <div id="popupfoot"><input type="submit" style="padding:6px;border: 2px solid #AA8278;
    border-radius: 4px;color:white;background-color:#582F2E;" value="I agree" name="save_changes" class="close agree" /></div>
  </div>
	...
	<section id="demo" style="background-color:#AA8278;">
	    <div class="vertical-align" style="background-color:#AA8278;">
			...
			<!------------------------ end all  ----------------------------->
									...
									<select name="callbackTest" conv-question="Want to go back Or view More Courses">
	                                    <option value="yes" callback="rollback">Yes</option>
	                                    <option value="no" callback="restore">No</option>

...
<head>
	...
	<!-- Meta Keyword -->
	<meta name="keywords" content="uisasbeautyschool,beauty salon,makeup,hair classes,beauty classes">
	<!-- meta character set -->
	<meta charset="UTF-8">
	<!-- Site Title -->
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/cidesco-diploma-in-beauty-therapy/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=all&c_name=cidesco" ></a></div>
    <!--<div id="boxes">
  ...
  <div class='window_popup'>
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/bgs.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">CIDESCO – Diploma in Beauty Therapy</h3>
								<a href="http://isasbeautyschool.com/cidesco-diploma-in-beauty-therapy/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/cdbt.jpg" width="100%">
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">CIDESCO Course in management</h3>
								<a href="http://isasbeautyschool.com/cidesco-course-in-management/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
			   ...
			   <!--End Content-->
			    ...
			    <!-- Start Cidesco – Diploma in Beauty & Spa Management Area 
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Cidesco – Diploma in Beauty & Spa Management</h3>
								<a href="http://isasbeautyschool.com/cidesco-diploma-in-beauty-spa-management-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/dbsm.jpg" width="100%">
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to CIDESCO</h3>
                    ...
                    <div class="row">
						...
						<div class="col-lg-3 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">CIDESCO – Diploma in Beauty Therapy</h6>
    ...
    <p class="text-black">* Public and Personal Hygiene, Microbiology / Bacteriology</p>	
	 <p class="text-black">* Methods of Sanitization and Sterilization Infection / Cross Infection</p>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/beauty_4.jpg);height: 16rem !important;">
									<!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="http://isasbeautyschool.com/cidesco-swiss/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
									</div>-->
								</div>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-3 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                        <h6 class="text-uppercase text-black">CIDESCO Course in management</h6>
                                       
                                        <p class="text-black">* INTRODUCTION (23)</p>
                                        <p class="text-black">* HUMAN RESOURCES (7)</p>
                                        <p class="text-black">* FINANCE (3)</p>
										<p class="text-black">* BUSINESS PLAN (3)</p>
										<p class="text-black">* LEADERSHIP (11)</p>
										<p class="text-black">* CONTINUED PROFESSIONAL DEVELOPMENT (2)</p>
										<p class="text-black">* STOCK CONTROL (9)</p>
										<p class="text-black">* MARKETING AND CUSTOMER RELATIONS (7)</p>

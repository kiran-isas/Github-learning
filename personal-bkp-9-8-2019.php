...
<head>
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/personal-grooming-2/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=personal_gromming&c_name=Personal Grooming"></a></div>
    <!--<div id="boxes">
...
<div class='container_popup'>
  <div class='window_popup'>
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/personal.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
			...
			<section id="show" class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Hair And Makeup</h3>
								<a href="http://isasbeautyschool.com/personal-grooming-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/pg.jpg" width="100%">
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/pd.jpg" width="100%">
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Head To Toe</h3>
								<a href="http://isasbeautyschool.com/personality-development-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to Corporate</h3>
                   ...
                   <div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">CERTIFICATE COURSE IN PERSONAL GROOMING</h6>
									<p class="text-black"><b>Certificate Course in Personal Grooming (A) : Duration: 9 hours</b></p>
                                              
									<p class="text-black">* 2 Looks (Either of)</P>
										<p class="text-black">1. Party western</P>
										<p class="text-black">2. Corporate</P>
										<p class="text-black">3. Function Occasion Traditional (with saree Draping 1 Style)</P>
									<p class="text-black">* Hairstyle, Eye & Face Makeup for Each look</P>
									<p class="text-black">* Individual Hair & Skin Analysis</P>
									<p class="text-black">* Product & Tool Knowledge</P>
                        ...
                        <div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									...
									<p class="text-black"><b>Certificate Course in Personal Grooming (B) : Duration: 15 hours</b></p>
                                      
    <p class="text-black">* 3 Looks</P>
        <p class="text-black">1. Party western</P>
        <p class="text-black">2. Corporate</P>
       <p class="text-black">3. Function Occasion Traditional (with saree Draping 1 Style)</P>
    <p class="text-black">* Hairstyle, Eye & Face Makeup for Each look</P>
    ...
    <p class="text-black">* Product & Tool Knowledge</P>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<p class="text-black"><b>Certificate Course in Personal Grooming (C) : Duration: 24 hours</b></p>
   ...
   <p class="text-black">*  Hairstyle, Eye & Face Makeup for Each look</P>
    <p class="text-black">* Individual Hair & Skin Analysis</P>
   <p class="text-black">*  Product & Tool Knowledge</P>
   <p class="text-black">*  Self Facial</P>
    <p class="text-black">* Self Manicure & Pedicure</P>
    <p class="text-black">* Self Waxing</P>
    <p class="text-black">* Self Threading</P>
                        ...
                        <div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
                                  ...
                                  <h6 class="text-uppercase text-black"> CERTIFICATE COURSE IN PERSONALITY DEVELOPMENT</h6>
								  
                                    <p class="text-black"><b>Duration: 36 Hrs</b></p>
									<p class="text-black">* Understanding the aspect of personality</p>
									<p class="text-black">* Confidence Building, Enthusiasm, Self-Motivation, Team motivation</p>
									<p class="text-black">* Goal Achievement</p>
									<p class="text-black">* Positive thinking</p>
									<p class="text-black">* Breaking Believes (Negative & Positive)</p>
									<p class="text-black">* Voice Modulation at various situations</p>
									<p class="text-black">* Communication – the art of reading, listening, writing.</p>
									<p class="text-black">* Public Speaking</p>
									<p class="text-black">* Presentation Skills (Practical)</p>
									<p class="text-black">* Body Language</p>
                        ...
                        <div class="col-lg-4 col-sm-6" >
                                <div class="single-service">
									...
									<p class="text-black">* Role Play (Practical)</p>
									<p class="text-black">* Values</p>
									<p class="text-black">* Family orientation, Human relations</p>
									<p class="text-black">* Study of emotions</p>
									<p class="text-black">* Self-Analysis – how to evolve & grow</p>
									<p class="text-black">* Project Planning, Time management</p>
									<p class="text-black">* Principles of Group Discussions</p>
									<p class="text-black">* Carrying the right attitude</p>
									<p class="text-black">* Stress Management</p>
									<p class="text-black">* Peer Pressure</p>
									<p class="text-black">* Discussion</p>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-4 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                   <p class="text-black"><b>Short Term Course in Personality Development : Duration: 14 Hrs</b></p>
                         
    <p class="text-black">* Aspect of Personality</p>
    <p class="text-black">* Communication Skills</p>
    <p class="text-black">* Body Language</p>
    <p class="text-black">* Personal Grooming</p>
    <p class="text-black">* Time Management</p>
    <p class="text-black">* Group Discussion</p>
    <p class="text-black">* Public Speaking</p>
    <p class="text-black">* Corporate Attire</p>
    <p class="text-black">* Confidences Building</p>

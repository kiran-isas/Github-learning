				...
				//alert(staff+">>>>>>>>>"+month+">>>>>>>>>>>>>"+year);
				   ...
				   // $("#showdiv").html(responseData);
					...
					//{
						...
						//alert(sep[1]);
						alert("Thank you, Records Successfully Submited");
						setTimeout('document.location.href="http://isasbeautyschool.com/"');
					//}
					//else
					//{
						//alert(sep[1]);
...
<div class='container_popup'>
  <div class='window_popup'>
    ...
    <div class='content_popup'>
      <div class='welcome_popup' style="margin-top: 30px;"><span style="color:#003">HELLO THERE !</span></b></div>
      <div class='subtitle_popup' style="margin-top: 15px;"><b style="color:#C30;">We would like to send you better information, so kindly share your email address and whatsapp mobile number.</b></div>
      <form method="post" name="jqueryForm" id="jqueryForm" enctype="multipart/form-data" >
     ...
     <center> <div style="padding:0px 0px 0px 0px;"><a onClick="javascript:$('.window').hide();$('#mask').hide();" class='ghost-round full-width-popup button_popup' style="padding:5px 20px 5px 20px;">Close</a></div></center>
      </form>
    </div>
  </div>
</div>

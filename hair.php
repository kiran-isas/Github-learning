...
<script>
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/basic-hair-dressing/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=basic_hair&c_name=Basic Hair" ></a></div>
    <!--<div id="boxes">
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/hair_banner.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Basic Hair Dressing</h3>
								<a href="http://isasbeautyschool.com/basic-hair-dressing/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/bhd.png" width="100%">
			...
			<!--<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/ahd.jpg" width="100%">
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Advance Hair Dressing</h3>
								<a href="http://isasbeautyschool.com/advance-hair-dressing/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to Hair</h3>
                    ...
                    <div class="col-lg-2 col-sm-6">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/hc1.jpg);height: 16rem !important;">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">BASIC HAIR DRESSING : Duration : 2 Months</h6>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-4 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/adv_hair.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="desc">
                                        <h6 class="text-uppercase text-black">ADVANCE HAIR DRESSING : Duration : 3 Months</h6>
                                        <p class="text-black">* Salon Management & Business Ethics</p> 
                                        <p class="text-black">* Health & Safety</p>
                                        <p class="text-black">* Hair Do's (10)</p>
                                        <p class="text-black">* Hair Cutting (7)</p>
                                        <p class="text-black">* Hair Treatments (5)</p>
                                        <p class="text-black">* Hair Cutting (8)</p>
                                        <p class="text-black">* Form & Texture</p>
                                        <p class="text-black">&nbsp;&nbsp;1.Perm Theory & Techniques</p>
                                        <p class="text-black">&nbsp;&nbsp;2.Rebonding – Hair Coloring</p>

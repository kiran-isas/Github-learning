...
<head>
	...
	<!-- Meta Keyword -->
	<meta name="keywords" content="isasbeautyschool,beauty salon,makeup,hair classes,beauty classes,cosmetology">
	<!-- meta character set -->
	<meta charset="UTF-8">
	<!-- Site Title -->
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/diploma-in-spa-therapy-2/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=spa_therapy&c_name=Diploma In Spa Therapy" ></a></div>
    <!--<div id="boxes">
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/spa.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/dis.jpg" width="100%">
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Diploma in Spa Therapy</h3>
                                <h3 class="text-white">Duration: 4 Months</h3>
								<a href="http://isasbeautyschool.com/diploma-in-spa-therapy-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Certificate course in Foot massage and reflexology</h3>
                                <h3 class="text-white">Duration: 15 days</h3>
								<a href="http://isasbeautyschool.com/certificate-course-in-foot-massage-and-reflexology-2/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/foot.jpg" width="100%">
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
                    	<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
								<img src="img/wspa.jpg" width="100%">
								
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Certificate course in Western Therapies</h3>
                                <h3 class="text-white">Duration: 15 Days</h3>
								<a href="http://isasbeautyschool.com/certificate-course-in-western-therapies/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
			...
			<section class="story-area" style="padding-top:20px;padding-bottom:20px;">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="story-title">
								<h3 class="text-white">Certificate course in Asian Therapies</h3>
                                <h3 class="text-white">Duration: 15 days</h3>
								<a href="http://isasbeautyschool.com/certificate-course-in-asian-therapies/" class="primary-btn hover d-inline-flex align-items-center" target="_blank"><span class="mr-10">Get Started</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box" style="padding:0px;" >
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to Spa</h3>
                    ...
                    <div class="row">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">Certificate course in Western Therapies</h6>
									
										<p class="text-black">* Anatomy / Physiology </p>
										<p class="text-black">* Massage Manipulations </p>
										<p class="text-black">* Swedish Massage </p>
										<p class="text-black">* Deep Tissue Massage </p>
										<p class="text-black">* Body Massage </p>
										<p class="text-black">* Body Scrubs </p>
										<p class="text-black">* Body Wraps </p>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">Certificate course in Asian Therapies</h6>
									

  

									<p class="text-black">* Anatomy / Physiology</p>
									<p class="text-black">* Asian Medicine Concept</p>
									<p class="text-black">* Reflexology</p>
									<p class="text-black">* Thai Massage</p>
									<p class="text-black">* Javanese Lulur</p>
									<p class="text-black">* Shiatsu Therapy</p>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">Certificate course in Foot massage and reflexology</h6>
									

									 <p class="text-black">* Anatomy & physiology</p>
									 <p class="text-black">* foot health</p>
									 <p class="text-black">* massage manipulation</p>
									 <p class="text-black">* acupressure</p>
									 <p class="text-black">* reflexology</p>
									 <p class="text-black">* aroma oils knowledge</p>
									 <p class="text-black">* benefits & contraindication</p>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-4 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                        <h6 class="text-uppercase text-black">Diploma in Spa Therapy</h6>
                                       
                                        <p class="text-black">* Introduction of spa</p>
										<p class="text-black">* History/ Origin Spa</p>
										<p class="text-black">* Types of Spa</p>
										<p class="text-black">* Types of Therapies</p>
										<p class="text-black">* Product Knowledge</p>
										<p class="text-black">* Room Setting</p>
										<p class="text-black">* Bed & Towel Setting</p>
										<p class="text-black">* Client handling & Etiquettes</p>
...
<p class="text-black">* Spa hygiene and sanitation</p>
<p class="text-black">* Basic Health & Safety in Spa</p>
<p class="text-black">* Spa Cuisine</p>
<p class="text-black">* Anatomy & Physiology</p>
<p class="text-black">* BMI, Body types & disorders</p>
<p class="text-black">* Massage Manipulations</p>
<p class="text-black">* Effects of Massage</p>
<p class="text-black">* Basic Body Steps</p>                                      
<p class="text-black">* Swedish</p>
<p class="text-black">* Deep Tissue</p>
<p class="text-black">* JavaneseeLulur</p>
...
<p class="text-black">* Asian Medicine Concept</p>
<p class="text-black">* Chakras</p>
<p class="text-black">* Reflexology</p>
<p class="text-black">* Thai Massage</p>
<p class="text-black">* Body Scrub</p>
<p class="text-black">* Body Wraps</p>
<p class="text-black">* Aromatherapy</p>
<p class="text-black">* Foot Rituals</p>
<p class="text-black">* Pre bridal Body Rituals</p>
<p class="text-black">* Cleopatra Body Polishing Treatment</p>
<p class="text-black">* Bath Therapies</p>
<p class="text-black">* Professional Management</p>

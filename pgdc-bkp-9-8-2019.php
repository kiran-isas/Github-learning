...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Post Graduation Diploma In Cosmetology - ISAS</title>
...
<script>
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/post-graduate-diploma-in-cosmetology/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=post_graduate_diploma&c_name=Post Graduatation Dipoma In Cosmetology" ></a></div>
    <!--<div id="boxes">
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/pgdc.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						<div class="col-lg-5">
							<div class="story-title">
								<h3 class="text-white">Post Graduate Diploma in Cosmetology</h3>
                                <h3 class="text-white">Duration: 1 Years</h3>
						...
						<div class="col-lg-7">
							<div class="story-box" style="text-align:center">
								<p class="text-uppercase">Beauty</p>
                                <p class="text-uppercase">Hair</p>
                                <p class="text-uppercase">Makeup</p>
                                <p class="text-uppercase">Makeup Looks</p>
                                <p class="text-uppercase">Spa</p>
                                <p class="text-uppercase">Nails</p>
								...
								<a href="http://isasbeautyschool.com/post-graduate-diploma-in-cosmetology/" target="_blank" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
             ...
             <section class="subscription-area" style="background:cornsilk;">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to PGDC</h3>
								<span class="text-uppercase">All Courses Follow National & International Qualifications.</span>
							</div>
						</div>
					</div>
					<center><h4 class="text-uppercase text-black">POST GRADUATE DIPLOMA IN COSMETOLOGY : Duration : 1 Year</h4></center>
                    <div class="row">
                   ...
                   <div class="col-lg-2 col-sm-6">
							<div class="single-service">
								...
								<div class="desc">
									   ...
									   <p class="text-black"><b>Beauty:</b></p>
										...
										<p class="text-black">* Skin Anatomy and Physiology</p>
										<p class="text-black">* Muscular</p>
										<p class="text-black">* Lymphatic & Skeletal System</p>
							...
							<div class="single-service">
								...
								<div class="desc">
									<p class="text-black">* Facials</p>
										...
										<p class="text-black">* Aroma Manicure/ Pedicure</p>
										<p class="text-black">* Paraffin Manicure/ Pedicure</p>
						...
						<div class="col-lg-2 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/pp.jpg);height: 16rem !important;">
									<!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="http://isasbeautyschool.com/cidesco-swiss/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
									</div>-->
								</div>
								<div class="desc">
								 <p class="text-black"><b>Hair</b></p>
									...
									<p class="text-black">* Tricology</p>
									<p class="text-black">* Hair Disorders</p>
									<p class="text-black">* Trolley Setting</p>
									<p class="text-black">* Client Consultation</p>
									<p class="text-black">* Shampooing & Conditioning</p>
									<p class="text-black">* Distribution Patterns</p>
									<p class="text-black">* Thermal Setting</p>
									<p class="text-black">* Blow Dry Setting</p>
									<p class="text-black">* Head Massage</p>
									<p class="text-black">* Heena Application</p>
									<p class="text-black">* Hair Styling</p>
                        ...
                        <div class="col-lg-2 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/hair_color.jpg);height: 16rem !important;">
									<!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="http://isasbeautyschool.com/cidesco-swiss/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
									</div>-->
								</div>
								<div class="desc">
                                    ...
                                    <p class="text-black">* Braids</p>
									<p class="text-black">* Up-styles</p>
									<p class="text-black">* Hair Cutting</p>
									<p class="text-black">* Hair Coloring</p>
									<p class="text-black">* Hair Do’s</p>
									<p class="text-black">* Hair Treatments</p>
									<p class="text-black">* Form & Texture</p>
									<p class="text-black">* Perming & Techniques</p>
									<p class="text-black">* Re-bonding</p>
									<p class="text-black">* Hair Coloring</p>
									<p class="text-black">* Salon Management & Business Ethics</p>
									<p class="text-black">* Health & Safety</p>
                        ...
                        <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/II.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                    ...
                                    <p class="text-black"><b>Makeup:</b></p>
                                   
									<p class="text-black">* Tools of the Trade</p>
									<p class="text-black">* Understanding Skin Types in Application</p>
									<p class="text-black">* Prep and Prime Tutorial</p>
									<p class="text-black">* Grading of colours for Features</p>
									<p class="text-black">* Eye Natural</p>
									<p class="text-black">* To Fashion Techniques</p>
									<p class="text-black">* Base Theory (Kyyolon)</p>
									<p class="text-black">* Product Theory</p>
									<p class="text-black">* Understanding features</p>
									<p class="text-black">* Buffing Skin to Natural Finish</p>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
									<p class="text-black">* Tones for Different Lights</p>
									<p class="text-black">* Full coverage to Natural Finish</p>
                                    <p class="text-black">* Shading</p>
									<p class="text-black">* Contouring Techniques</p>
									<p class="text-black">* Makeup Alignment</p>
									<p class="text-black">* Longwear& Waterproof</p>
									<p class="text-black">* Makeup Looks: Shear</p>
									<p class="text-black">* Day Self</p>
									<p class="text-black">* Nude/Wet</p>
									<p class="text-black">* Party</p>
									<p class="text-black">* Engagement</p>
									<p class="text-black">* Bridal</p>
									<p class="text-black">* Reception</p>
									<p class="text-black">* Groom</p>
                           ...
                           <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/m.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
									<p class="text-black">* Corrective</p>
									<p class="text-black">* How to Clean Makeup</p>
                                    <p class="text-black">* Personality</p>
									<p class="text-black">* Ramp</p>
									<p class="text-black">* Glossy</p>
									<p class="text-black">* Fantasy</p>
									<p class="text-black">* Festive</p>
									<p class="text-black">* Character</p>
									<p class="text-black">* Retro</p>
									<p class="text-black">* Portfolio</p>
									<p class="text-black">* Illusion</p>
									<p class="text-black">* Portfolio</p>
									<p class="text-black">* Effects of Light on Makeup</p>
							...
							<div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/look1.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black"></h6>
                              			  ...
                              			  <p class="text-black"><b>Makeup Looks:</b></p>
                                             
											<p class="text-black">* Shear</p>
											<p class="text-black">* Day Self</p>
											<p class="text-black">* Nude/Wet</p>
											<p class="text-black">* Party</p>
											<p class="text-black">* Engagement</p>
							...
							<div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/look2.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
							 ...
							 <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/spa1.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black"></h6>
                                           ...
                                           <p class="text-black"><b>Spa:</b></p>
                                           
												<p class="text-black">* History of Spa</p>
												<p class="text-black">* Types of Spa</p>
												<p class="text-black">* Types of Therapies</p>
												<p class="text-black">* Product Knowledge</p>
												<p class="text-black">* Room</p>
												<p class="text-black">* Bed & Towel Setting</p>
												<p class="text-black">* Client Consultation</p>
												<p class="text-black">* Lifestyle Patterns</p>
												<p class="text-black">* Spa Hygiene & Sanitation</p>
												<p class="text-black">* Spa Cuisine</p>
                            ...
                            <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/spa2.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                    <p class="text-black">* Anatomy & Physiology</p>
												<p class="text-black">* BMI</p>
												<p class="text-black">* Body types & Disorders</p>
												<p class="text-black">* Massage Manipulations</p>
												<p class="text-black">* Basic Body steps</p>
												<p class="text-black">* Swedish</p>
												<p class="text-black">* Deep Tissue</p>
												<p class="text-black">* Javanese Lulur</p>
												<p class="text-black">* Hand Spa/ Foot Spa</p>
												<p class="text-black">* Spa Designs & Operations</p>
												<p class="text-black">* Basic Management</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/nail1.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                    <p class="text-black"><b>Nails:</b></p>
												
										<p class="text-black">* Introduction to Nail industry</p>
										<p class="text-black">* Nail Structure</p>
										<p class="text-black">* Technician Qualities</p>
										<p class="text-black">* Health & safety & opportunities</p>
										<p class="text-black">* Nail products and their ingredients</p>
										<p class="text-black">* Cut</p>
										<p class="text-black">* File</p>
										<p class="text-black">* Buff</p>
										<p class="text-black">* Nail Paint Application ( base , color, top),</p>
										<p class="text-black">* Nail Art – Demonstration</p>
					...
					<div class="active-works-carousel mt-40">
                    	<div class="item">
							...
							<div class="caption text-center">
								<h6 class="text-uppercase">Post Graduate Diploma in Cosmetology</h6>

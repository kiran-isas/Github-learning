...
?>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Master In Cosmetology - ISAS</title>
...
<script>
			...
			var cm_ids='<?php echo $cm_id; ?>';
			   ...
			   // $("#showdiv").html(responseData);
				...
				if(sep[0]=='1')
				{
					...
					setTimeout('document.location.href="http://isasbeautyschool.com/masters-program-in-cosmetology/"');
				}
				else
				{
					alert(sep[1]);
	...
	else
	{
  	...
  	?>
    <div id="suggestPost"><a target="_blank" href="convForm-master/index.php?type=master_program&c_name=Master Program In Cosmetology" ></a></div>
    <!--<div id="boxes">
    ...
    <div style="width: 1478px; font-size: 32pt; color:white; height: 602px; display: none; opacity: 0.8;" id="mask"></div>
		...
		<div class="main-wrapper-first">
			...
			<div class="banner-area">
				<div class="container">
					<div class="row justify-content-center height align-items-center" style="background-image: url('img/mic.jpg');background-repeat: no-repeat;background-size: cover;background-size: 100% auto;"><!---->
						<div class="col-lg-12">
					...
					<div class="row align-items-center">
						<div class="col-lg-5">
							<div class="story-title">
								<h3 class="text-white">Master In Cosmetology</h3>
                                <h3 class="text-white">Duration: 2 Years</h3>
								<span class="text-uppercase text-white">Course Content :</span>
							</div>
						</div>
                        <!--<div class="col-lg-3">
						...
						<div class="col-lg-7">
							<div class="story-box" style="text-align:center">
								<p class="text-uppercase">Diploma in Make-up</p>
                                <p class="text-uppercase">Diploma in Hair designing</p>
                                <p class="text-uppercase">CIDESCO Beauty Therapy</p>
                                <p class="text-uppercase">Basic Course In Aesthetics</p>
                                <p class="text-uppercase">Diploma in Spa therapies</p>
                                <p class="text-uppercase">Permanent Nail Extension & Art</p>
                                <p class="text-uppercase">Creative Course in hair Designing</p>
                                <p class="text-uppercase">Salon Management</p>
								...
								<a href="http://isasbeautyschool.com/masters-program-in-cosmetology/" target="_blank" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="section-title text-center">
								<h3>List of all Courses Related to MIC</h3>
								<span class="text-uppercase">All Courses Follow National & International Qualifications.</span>
							</div>
						</div>
					</div>
					
					<center><h4 class="text-uppercase text-black">MASTER PROGRAM IN COSMETOLOGY : Duration : 2 Years</h4></center>
					
                    <div class="row">
                   
                   <div class="col-lg-2 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/j.jpg);height: 16rem !important;">
								...
								<div class="desc">
									<h6 class="text-uppercase text-black">DIPLOMA IN MAKEUP</h6>
									<p class="text-black">* INTERNATIONAL AND NATIONAL MAKEUP KNOWLEDGE (6)</p>
									 <p class="text-black">* PROFESSIONALISM (4)</p>
									 <p class="text-black">* OPERATIONS & QUALITY CONTROL (14)</p>
									 <p class="text-black">* PRACTICAL COMPULSORY TRAINING (4)</p>
									 <p class="text-black">* CLASSIFICATION & APPLICATION OF MAKEUP TECHNIQUES (12)</p>
									 <p class="text-black">* PR & MARKETING (3)</p>
									 <p class="text-black">* COMMERCIAL STUDIES / BUSINESS STUDIES (10)</p>
									 <p class="text-black">* PORTFOLIO (3)</p>
                        ...
                        <div class="col-lg-2 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/hair.jpg);height: 16rem !important;">
									<!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="http://isasbeautyschool.com/cidesco-swiss/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
									</div>-->
								</div>
								<div class="desc">
										<h6 class="text-uppercase text-black">DIPLOMA IN HAIR DESIGNING</h6>
										Creative Unisex Hair Designing (12)
										Media Hair Style (5)
										Hair Extensions (2)
										Trendy Color Techniques (8)
										Hair Relaxing Techniques (4)
						...
						<div class="col-lg-2 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/beauty_2.jpg);height: 16rem !important;">
									<!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="http://isasbeautyschool.com/cidesco-swiss/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
									</div>-->
								</div>
								<div class="desc">
									<h6 class="text-uppercase text-black">CIDESCO - BEAUTY THERAPY</h6>
                                    <p class="text-black">* Natural Science—Chemistry & Physics</p>
                                    <p class="text-black">* Elements, Compounds and Mixture Ph Scale</p>
                                    <p class="text-black">* Electricity Effects on the Body</p>
                                    <p class="text-black">* Knowledge and Understanding of Applicable Currents</p>
                                    <p class="text-black">* Precautions in Use of Electricity</p>
                                    <p class="text-black">* Anatomy and Physiology</p>
                                    <p class="text-black">* Cells and Tissue Metabolism Body Systems Including Myology</p>
                        ...
                        <div class="col-lg-2 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(img/beauty_3.jpg);height: 16rem !important;">
									<!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="http://isasbeautyschool.com/cidesco-swiss/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
									</div>-->
								</div>
								<div class="desc">
                                    ...
                                    <p class="text-black">* Skin / Dermatology</p>
                                    <p class="text-black">* Hygiene and First Aid</p>
                                    <p class="text-black">* Public and Personal Hygiene, Microbiology / Bacteriology</p>
                                   
                                    <p class="text-black">* Methods of Sanitization and Sterilization Infection / Cross Infection</p>
                                    <p class="text-black">* Immunity, Health and Safety at Work</p>
                                    <p class="text-black">* Aesthetic Treatments – Practical and Theory As Shown In Syllabus</p>
                                    <p class="text-black">* Skin Care Consultation Treatment Procedures, Deep Cleansing</p>
                                   <p class="text-black">* Facial Massage Mask Therapy</p>
                        ...
                        <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                     ...
                                     <p class="text-black">* Facial Electro therapy including Galvanic Current, High Frequency</p>
                                    <p class="text-black">* Electrical Muscle Stimulation (faradic Type) Micro Current</p>
                                    <p class="text-black">* Body Analysis Body Massage, Body Therapy Manual Techniques</p>
                                   <p class="text-black">* Body Electrical Treatments, Heat Treatments</p>
                                    <p class="text-black">* Ultra Violet And Infrared, Light Therapy</p>
                                    <p class="text-black">* Hair Removal</p>
                                    <p class="text-black">* Ancillary Services – Eyebrow Shaping, Eyelash And Eyebrow Tinting</p>
                        ...
                        <!--For mobile view don't show-->
                            <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/H.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    ...
                                    <p class="text-black">* Bleaching Of Face And Body</p>
                                    <p class="text-black">* Hair, Make-up</p>
                                    <p class="text-black">* Manicure And Pedicure -nail Care And Foot Treatment</p>
                                    <p class="text-black">* Cosmetic Products</p>
                                    <p class="text-black">* Cosmetic Science (basic)</p>
                                    <p class="text-black">* Cosmetic Surgery (basic General Knowledge)</p>
                                    <p class="text-black">* Nutrition-diet professional Ethics Commercial Studies-business Studies</p>
                                    <p class="text-black">* Additional/specialized Subject (practical And Theory) client Interaction Sessions</p>
                           ...
                           <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/C.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black">PERMANENT NAIL EXTENSION AND ART</h6>
                                       
                              			 
                                            <p class="text-black"><b>NAIL ART</b></p>
                                            <p class="text-black">* Floral design</p>
                                            <p class="text-black">*  Glitters</p>
                                            <p class="text-black">*  Stones</p>
                                            <p class="text-black">*  Color Combination</p>
							...
							<div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/nail2.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black"></h6>
                                       
                              			  <p class="text-black"><b>NAIL EXTENSION</b></p>
                                              <p class="text-black"><b>Duration: 7 Days</b></p>
                                           
                                             <p class="text-black">* Either Acrylic Gel</p>
                                             <p class="text-black">* ACNU Gel</p>

 											<p class="text-black"><b>Duration: 1 Month</b></p>
                                            

                                            <p class="text-black">* Gel, Acrylic & Acnugel</p>
                                            <p class="text-black">* Nail Dressing</p>
                                            <p class="text-black">* Gelicure</p>

											<p class="text-black"><b>Duration: 15 Days</b></p>
							...
							<div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/bd.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black">CREATIVE COURSE IN HAIR DRESSING</h6>
                                       
                              			 
                                            <p class="text-black"><b>HAIR</b></p>
                                            <p class="text-black">* Creative Unisex Hair Designing (12)</p>
                                            <p class="text-black">*  Media Hair Style (5)</p>
                                            <p class="text-black">*  Hair Extensions (2)</p>
                                            <p class="text-black">* Basic Cuts and Blow Dry (5)</p>
											<p class="text-black">* Blow Dry (5)</p>
                                ...
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black"></h6>
                                           ...
                                           <p class="text-black"><b>BEAUTY</b></p>
                                             <p class="text-black">* Manicure & Pedicure (10 days) (3)</p>
                                             <p class="text-black">* Makeup (10 days) (4)</p>
											 <p class="text-black">* Hair Styling (5)</p>
											<p class="text-black">* Basic Hair Styling With Hot Equipment (5)</p>
                                            <p class="text-black">* Short 5 days course (5 days) (5)</p>
                                            <p class="text-black">* Facials (6-7 days) (3)</p>
                            ...
                            <div class="col-lg-2 col-sm-6" >
                                <div class="single-service">
                                    <div class="thumb" style="background: url(img/C2.jpg);height: 16rem !important;">
                                        <!--<div class="overlay overlay-content d-flex justify-content-center align-items-center">
                                            <a href="http://isasbeautyschool.com/vtct/" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Know More</span><span class="lnr lnr-arrow-right"></span></a>
                                        </div>-->
                                    </div>
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black">CERTIFICATE COURSE IN SALON/SPA MANAGEMENT</h6>
                                       
                              			 
                                            <p class="text-black"><b>Before Launch of the Salon</b></p>
                                            <p class="text-black">* Business Plan (6)</p>
                                            <p class="text-black">* Survey (Close to the Property) (1)</p>
                                            <p class="text-black">* Registrations (9)</p>
                                            <p class="text-black">* Project Plan (5)</p>
											<p class="text-black">* Execution (2)</p>
											<p class="text-black">* Recruitment (5)</p>
                                ...
                                <div class="single-service">
                                    ...
                                    <div class="desc">
                                     <h6 class="text-uppercase text-black"></h6>
                              			    ...
                              			    <p class="text-black">* Training  (1)</p>
											<p class="text-black">* Procurement  (1)</p>
											<p class="text-black">* Advertising  (1)</p>
											<p class="text-black">* Launch  (1)</p>
                                            <p class="text-black"><b>After Launch of the Salon</b></p>
                                            <p class="text-black">* Operational Processes (12)</p>
                                            <p class="text-black">* Marketing & Promotions (6)</p>
					...
					<div class="active-works-carousel mt-40">
                    	<div class="item">
							...
							<div class="caption text-center">
								<h6 class="text-uppercase">Master In Cosmetology</h6>
